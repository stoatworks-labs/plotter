...
## Released
- v0.1.0, 2026-09-24, at `github.com/stoatworks-labs/plotter`, with a user guide,
  a browser demo and a project video.
- **Never loaded into Resolume on macOS.** On Windows it has run in Resolume Arena 7.27.1 on software rendering (win-lab): the fleet gate's 9/9, all 19 controls live.
- Footage has been seen through `--pipe` only (the project video).
